		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<panel noButton="true" bodyClass="bg-silver">
					...
					<div class="chats overflow-scroll" style="height: 225px;">
						<div class="left">
				...
				<panel title="Today's Schedule" noButton="true" noBody="true">
					<template slot="outsideBody">
						...
						<div class="list-group">
							...
							<a href="javascript:;" v-for="event in events.displayData" class="list-group-item d-flex justify-content-between align-items-center text-ellipsis">
								{{ event.title }}
